      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <main className="w-full lg:w-3/4">
          <div className="bg-gray-700 p-6 rounded-xl shadow-lg mb-8">
            ...
            <div className="slider-container" id="action-slider">
              <button className="slider-button left" data-direction="prev">
                <i className="fas fa-chevron-left"></i>
              </button>
              <button className="slider-button right" data-direction="next">
          ...
          <div className="bg-gray-700 p-6 rounded-xl shadow-lg mb-8">
            ...
            <div className="slider-container" id="policiaco-slider-1">
              <button className="slider-button left" data-direction="prev">
                <i className="fas fa-chevron-left"></i>
              </button>
              <button className="slider-button right" data-direction="next">
          ...
          <div className="bg-gray-700 p-6 rounded-xl shadow-lg mb-8">
            ...
            <div className="slider-container" id="policiaco-slider-2">
              <button className="slider-button left" data-direction="prev">
                <i className="fas fa-chevron-left"></i>
              </button>
              <button className="slider-button right" data-direction="next">
          ...
          <div className="bg-gray-700 p-6 rounded-xl shadow-lg mb-8">
            ...
            <div className="slider-container" id="policiaco-slider-3">
              <button className="slider-button left" data-direction="prev">
                <i className="fas fa-chevron-left"></i>
              </button>
              <button className="slider-button right" data-direction="next">
